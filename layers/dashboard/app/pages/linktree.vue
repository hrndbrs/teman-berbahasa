...
const registrationItems = [
  {
    value: 'registration',
    label: 'Daftar Kelas Bahasa Jepang',
          ...
          <div class="space-y-3">
            <UAccordion
              ...
              :ui="{
                item: 'border-b-0',
                trigger:
                  'tb-link w-full items-center justify-between gap-3 rounded-xl border border-gray-200 bg-gray-50 px-5 py-4 text-left text-sm font-medium text-gray-900 transition hover:-translate-y-0.5 hover:border-gray-300 hover:bg-white hover:shadow-lg hover:shadow-gray-200/60 active:scale-[0.99]',
                label: 'flex-1',
                leadingIcon: 'size-4 text-gray-900',
                trailingIcon: 'size-4 text-gray-500',
                content: 'mt-2 rounded-xl border border-gray-200 bg-white',
                body: 'space-y-2 p-3',
              }"
            >
              <template #registration>
                ...
                >
                  <div
                    v-if="link.isExpired"
                    class="flex w-full cursor-not-allowed items-center justify-between gap-3 rounded-lg border border-gray-100 bg-gray-50 px-4 py-3 text-left text-sm font-medium text-gray-400"
                  >
