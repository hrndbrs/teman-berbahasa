          ...
          >
            ...
            >
              ...
              <a
                ...
                class="bg-tb-blue-3 inline-block rounded-full px-6 py-2 text-sm text-white transition hover:bg-blue-800"
              >
                Daftar Sekarang
              </a>
              <a
                ...
                aria-disabled="true"
                tabindex="-1"
                class="pointer-events-none inline-block cursor-not-allowed rounded-full bg-gray-200 px-6 py-2 text-sm text-gray-500"
              >
                Sudah Berakhir
              </a>
            </div>
