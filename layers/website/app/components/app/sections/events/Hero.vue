...
<template>
  <section
    ...
    class="relative flex h-dvh items-center justify-center overflow-hidden bg-white"
  >
    <!-- Hero Image -->
    <div
      ref="imageWrapperRef"
      class="aspect-[3/2] w-4/5 origin-center"
    >
      <NuxtImg
    ...
    >
      <div class="text-center text-gray-900">
        ...
        <p class="mt-4 text-sm md:text-base">Mini Course</p>
      </div>
    </div>
  </section>
</template>
