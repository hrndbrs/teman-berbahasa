  ...
  >
    <div class="container px-6">
      ...
      >
        ...
        <NuxtLink
          to="/courses"
          class="text-tb-blue-3 inline-flex items-center gap-2 text-sm font-semibold hover:text-blue-800"
        >
          Lihat Semua Kelas
          <Icon
      ...
      >
        ...
        >
          <div class="flex flex-1 flex-col p-6">
            <span
              class="text-tb-blue-3 mb-3 inline-block w-fit rounded-full bg-blue-50 px-3 py-1 text-xs font-medium"
            >
              {{ course.category }}
            </span>
