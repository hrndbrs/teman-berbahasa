      ...
      >
        ...
        >
          ...
          <span
            ...
            class="bg-tb-blue-3 absolute bottom-0 left-0 h-0.5 w-full"
          />
        </button>
      </div>
        ...
        >
          ...
          >
            ...
            <div class="border-b border-gray-100 bg-gray-50 p-6">
              <div
                class="flex flex-col items-end justify-between gap-8 md:flex-row md:items-start"
              >
                ...
                <div class="flex shrink-0 flex-col items-end gap-2">
                  <span class="text-tb-blue-3 text-lg font-bold md:text-xl">
            ...
            >
              ...
              >
                ...
                <a
                  ...
                  class="bg-tb-blue-3 inline-block rounded-md px-5 py-2.5 text-center text-sm font-medium text-white transition hover:bg-blue-800 md:justify-self-end"
                >
                  Daftar Sekarang
                </a>
              </li>
