  ...
  >
    ...
    <div class="container px-6">
      ...
      <div class="grid gap-12 lg:grid-cols-[2fr_1fr]">
        ...
        <div>
          <span
            class="text-tb-blue-3 mb-4 inline-block rounded-full bg-blue-50 px-3 py-1 text-sm font-medium"
          >
            {{ course.category }}
          </span>
              ...
              >
                <div class="grid gap-4 @md:grid-cols-2 @3xl:grid-cols-3">
                  <div class="flex items-center gap-3">
                    <div
                      class="text-tb-blue-3 flex size-10 shrink-0 items-center justify-center rounded-lg bg-blue-50"
                    >
                      <Icon
                ...
                <a
                  ...
                  class="bg-tb-blue-3 inline-flex shrink-0 items-center justify-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-white transition hover:bg-blue-800"
                >
                  Daftar
                  <Icon
            ...
            >
              ...
              <ul class="space-y-4">
                ...
                >
                  ...
                  <span class="text-tb-blue-3 text-lg font-bold">
